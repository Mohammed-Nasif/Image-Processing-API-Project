...
var validation = function (Inputs) { return __awaiter(void 0, void 0, void 0, function () {
    var W, H;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, imagesfiles_1.default.validatingImgName(Inputs.Image)];
            case 1:
                /*
                ...
                */
                if (!Inputs.W && !Inputs.H) {
                    return [2 /*return*/, 'Please Enter A valid positive value for the Width and Height.'];
                }
                W = +Number(Inputs.W);
...
images.get('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, validation(request.query)];
            case 1:
                ...
                error = '';
                return [4 /*yield*/, imagesfiles_1.default.resizedBefore(request.query)];
            case 2:
                if (!!(_a.sent())) return [3 /*break*/, 4];
                return [4 /*yield*/, imagesfiles_1.default.imageManpulation(request.query)];
            case 3:
                error = _a.sent();
                _a.label = 4;
            case 4:
                ...
                return [4 /*yield*/, imagesfiles_1.default.requiredImage(request.query)];
            case 5:
                path = _a.sent();
                if (path) {
